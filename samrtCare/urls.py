...
urlpatterns = [
    ...
    # Nurse
    path('nurse_home/', core_views.nurse_home, name='nurse_home'),

    path('approve_nurse_appointment/<int:appointment_id>/', core_views.approve_nurse_appointment,
         name='approve_nurse_appointment'),
    path('update_nurse_appointment/<int:appointment_id>/', core_views.update_nurse_appointment,
         name='update_nurse_appointment'),
    path('reject_nurse_appointment/<int:appointment_id>/', core_views.reject_nurse_appointment,
         name='reject_nurse_appointment'),
